...
public class ProductWithPhoto {
    ...
    public ProductWithPhoto(Products product) {
        pid = product.getPid();
    ...
    public ProductWithPhoto(int pid, String product_name, double price, int product_number, String isbn, int category_id, int product_status, Date create_time, Date update_time, int created_by_uid, String text, List<String> image) {
        this.pid = pid;
